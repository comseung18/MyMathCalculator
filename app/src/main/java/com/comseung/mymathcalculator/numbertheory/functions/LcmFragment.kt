...
class LcmFragment: BaseFragment<TwoValueCaculatorLayoutBinding>(TwoValueCaculatorLayoutBinding::inflate) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnCalculate.setOnClickListener {
            ...
            binding.result.setText(MathFunctions.lcm(a, b).toString())
        }
    }
}