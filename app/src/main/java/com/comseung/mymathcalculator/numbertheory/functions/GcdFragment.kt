...
class GcdFragment: BaseFragment<TwoValueCaculatorLayoutBinding>(TwoValueCaculatorLayoutBinding::inflate) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnCalculate.setOnClickListener {
            ...
            binding.result.setText(MathFunctions.gcd(a, b).toString())
        }
